...
{	
	...
	$codigohtml = "Nombre:&#09;".$_POST['Nombre'];
 	...
 	$codigohtml.= "<br>Compañia:&#09; ".$_POST['Compania'];
	...
	$codigohtml.= "<br>Texto E Imágenes:&#09;".$_POST['Material'];
	$codigohtml.= "<br>Mantenimiento:&#09;".$_POST['Mantenimiento'];
  	$codigohtml.= "<br>Presupuesto con el que cuento:&#09;".$_POST['Presupuesto'];
	$codigohtml.= "<br>Dirección del Sitio Actual de la Empresa:&#09;".$_POST['direccionUrl'];
	$codigohtml.= "<br>La Empresa cuenta con un Dominio:&#09;".$_POST['nombredominio'];
 	...
 	$codigohtml.= "<br>Interés Del Proyecto:&#09;".$_POST['Intereses'];

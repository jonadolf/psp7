<table class="table">
					<tr>
						...
						<td>{!!Form::text('lenguaje', $var->lenguaje);!!}</td>
					</tr>
					<tr>
						<td>tipo conteo (físico / lógico)</td>
						<td>{!!Form::select('tipoConteo', array('anterior'=>$var->tipoConteo,'si' => 'Si','no'=>'No'));!!}
					...
					<tr>
						...
						<td>{!!Form::select('ejecutables', array('anterior'=>$var->ejecutables,'si' => 'Si','no'=>'No'))!!}</td>
					...
					<tr>
						...
						<td>{!!Form::select('declaraciones', array('anterior'=>$var->declaraciones,'si' => 'Si','no'=>'No'));!!}</td>
					</tr>
					<tr>	
						<td>Directivas del compilador</td>
						<td>{!!Form::select('dCompilador', array('anterior'=>$var->dCompilador,'si' => 'Si','no'=>'No'));!!}</td>
					</tr>
					<tr>
						<td>Comentarios</td>
						<td>{!!Form::select('comentarios', array('anterior'=>$var->comentarios,'si' => 'Si','no'=>'No'));!!}</td>
					</tr>
					<tr>
						<td>Lineas en blanco</td>
						<td>{!!Form::select('lineasBlanco', array('anterior'=>$var->lineasBlanco,'si' => 'Si','no'=>'No'));!!}</td>
					</tr>
					<tr>
						<td  style="align-content: center;">Delimitadores { }</td>
						<td>{!!Form::select('delimitadores', array('anterior'=>$var->delimitadores,'si' => 'Si','no'=>'No'));!!}</td>
					</tr>
					<tr>

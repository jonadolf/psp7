			...
			<div class="col-md-12 ">
				<div class="panel panel-default">
					...
					<div class="form-group">
						 ...
						 <tr>
						 <td>
						<select id="cantidadProyectos" name="cantidadProyectos" onChange="mostrar(this.value);">
						...
						<td>
						<?php echo Form::text('usuarioSesion',$id = Auth::id(),['class'=>'form-control','style'=>'color: black']); ?>

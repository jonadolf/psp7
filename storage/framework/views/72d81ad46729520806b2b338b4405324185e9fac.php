    ...
    <div id="app">
        <div class="register-box">
            <div class="register-logo">
                <a href="<?php echo e(url('/home')); ?>"><b>Sistema</b>PSP 7</a>
            </div>
            ...
            <div class="register-box-body">
                ...
                <form action="<?php echo e(url('/register')); ?>" method="post">
                    ...
                    <div class="form-group has-feedback">
                        <?php echo e(Form::label('tipoUsuario1', 'Tipo de usuario', ['class' => 'control-label'])); ?>  <?php echo Form::select('tipoUsuario',  ['Seleccione...','Asesor','Estudiante']); ?>
